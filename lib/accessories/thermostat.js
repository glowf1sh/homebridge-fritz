...
module.exports = function(homebridge) {
    ...
    async setTargetHeatingCoolingState(state) {
        ...
        if (state === Characteristic.TargetHeatingCoolingState.OFF) {
            ...
            await this.platform.fritz("setTempTarget", this.ain, tempToSet);
    ...
    this.platform.fritz('getTempTarget', this.ain).then(temperature => {
        ...
        if (temperature === "off") {
            // When OFF, keep showing the last active temperature (grayed out in UI)
            targetTemperature = this.lastActiveTargetTemperature || service.fritzTargetTemperature;
            ...
            // Update last active temperature when device is ON
            this.lastActiveTargetTemperature = targetTemperature;
