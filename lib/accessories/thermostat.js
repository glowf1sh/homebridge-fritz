...
module.exports = function(homebridge) {
    ...
    async getCurrentTemperature() {
        ...
        // Check if device is offline (only if we have device data)
    ...
    this.platform.fritz('getBatteryCharge', this.ain).then(batteryLevelFromApi => {
        ...
        const lastBatteryLevel = service.lastLoggedBatteryLevel || -1;
        const shouldLog = Math.abs(validBatteryLevel - lastBatteryLevel) >= 5 || // Log if changed by 5% or more
